...
29. SELECT PRO_COM, AVG(PRO_PRICE) FROM item_mast GROUP BY PRO_COM;

30. SELECT PRO_NAME, PRO_PRICE FROM item_mast ORDER BY PRO_PRICE;

31. SELECT DISTINCT EMP_LNAME FROM emp_details;

32. SELECT EMP_FNAME, EMP_LNAME FROM emp_details WHERE EMP_LNAME='Snares';
